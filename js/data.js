...
const LIMITES = [
  ...
  { id: 'L4', nombre: 'Instrumentos BBB o inferiores', norma: 'Política interna INV-07 §4.2', tipo: 'Política interna', limite: '≤ 3% del total', uso: 56.7, base: '1,7% vs tope 3%', formula: 'Σ VM instrumentos rating ≤ BBB+ / Σ VM cartera', posiciones: ['PAN-32'], hist: [51, 53, 52, 55, 56, 56.7] },
  ...
  { id: 'L6', nombre: 'Descalce de moneda (USD sin cobertura)', norma: 'Política interna INV-07 §5.1', tipo: 'Política interna', limite: '≤ 8% del total', uso: 91.2, base: '7,3% vs tope 8%', formula: '(Activos USD − pasivos USD − forwards) / Σ VM cartera', posiciones: ['UST-10Y','UST-30Y','JPM-31','ETF-SPX','ALT-PD'], hist: [78, 81, 84, 87, 89, 91.2] },
  ...
  { id: 'L10', nombre: 'Instrumentos de un mismo banco (DAP)', norma: 'Política interna INV-07 §4.4', tipo: 'Política interna', limite: '≤ 4% por banco', uso: 48.0, base: '1,9% en BCI vs tope 4%', formula: 'Σ DAP + bonos del banco / Σ VM cartera', posiciones: ['DAP-CLP'], hist: [45, 50, 47, 46, 49, 48.0] },
  ...
  { id: 'L12', nombre: 'Activos alternativos', norma: 'Política interna INV-07 §4.6', tipo: 'Política interna', limite: '≤ 7% del total', uso: 79.4, base: '5,6% vs tope 7%', formula: 'Σ VM fondos alternativos / Σ VM cartera', posiciones: ['ALT-INFRA','ALT-PD'], hist: [70, 73, 75, 76, 78, 79.4] },
];
...
const POLITICA = {
  ...
  objetivo: 'Establecer el marco de inversión de las reservas técnicas y patrimonio de MetLife Chile, asegurando el calce de activos y pasivos, el cumplimiento del marco regulatorio CMF (DFL 251, NCG 152 y NCG 461) y la generación de retornos consistentes con el apetito de riesgo aprobado por el Directorio.',
  principios: [
    'Calce de activos y pasivos como criterio rector de la asignación estratégica.',
    ...
    'Gestión de moneda: exposición USD sin cobertura acotada por política interna.',
    'Toda excepción requiere aprobación del Comité de Inversiones y registro en acta.',
  ],
};

const VERSIONES_POLITICA = [
  { version: 'v4.2', vigencia: '01-04-2026', estado: 'Vigente', cambios: 'Incorpora límite de activos alternativos (≤ 7%) y actualiza el marco de descalce de moneda tras la revisión anual del apetito de riesgo.' },
  { version: 'v4.1', vigencia: '01-10-2025', estado: 'Histórica', cambios: 'Ajuste del límite interno de instrumentos BBB o inferiores de 4% a 3%; actualización de referencias a NCG 461.' },
...
const OPT = {
  ...
  restricciones: [
    ...
    { nombre: 'Descalce USD sin cobertura ≤ 8% (INV-07)', limiteId: 'L6', estado: 'Activa' },
    { nombre: 'Activos alternativos ≤ 7% (INV-07)', limiteId: 'L12', estado: 'Activa' },
